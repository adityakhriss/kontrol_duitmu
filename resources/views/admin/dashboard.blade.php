<x-app-layout>
    ...
    <x-slot name="description">Monitor user, integrasi berita, dan sinkronisasi sistem dari satu panel.</x-slot>
    ...
    <div class="space-y-6">
        <section class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <x-ui.stat-card label="API berita" :value="$apiConfig?->is_active ? 'Aktif' : 'Nonaktif'" :trend="'Sync tiap '.($apiConfig?->sync_interval_minutes ?? 60).' menit'" tone="amber" />
        ...
        <section class="grid gap-4 xl:grid-cols-[1fr_1fr]">
            <x-ui.panel title="Shortcut admin" description="Akses cepat ke menu inti.">
                <div class="grid gap-3 sm:grid-cols-2">
                    ...
                    <a href="{{ route('admin.api-settings') }}" class="rounded-[1.5rem] bg-white p-4 font-semibold text-slate-950">Setting API berita</a>
